...
const mazda6 = {
  ...
  return (
    <div className="App ">
      <h1 className="text-4xl font-semibold text-blue-900 mb-3 mt-5 items-center flex justify-center">Lets See How Much Randy Has Saved so far!</h1>
      ...
      <input
                    ...
                    Maintenance Info:
                  <div className="border-2 items-center justify-center bg-slate-700 shadow-md shadow-blue-700 w-full ml-[15%]  mr-[10%] overflow-auto border-black p-2 flex font-semibold flex-row">
                    <div>

                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center flex justify-center">Oil</div>
                    <div className="border-2 p-3 bg-gray-200  border-black mb-7 h-5 mt-2 text-center items-center flex justify-center">Oil-Filters</div>
                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center flex justify-center">Headlights</div>
                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center flex justify-center">Lows</div>
                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center flex justify-center">Spark</div>
                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center flex justify-center">Wipers</div>
                    <div className="border-2 p-3 bg-gray-200 border-black h-5 mt-2 text-center items-center mb-7 flex justify-center">Lights</div>
                    ...
                    <div className=" ml-5 p-3 border-2 bg-gray-200 border-black h-12 mt-2 text-center items-center flex justify-center">Mobile1: {mazda6.OilFilter.Mobile1} <p className=" ml-5"> Fram: {mazda6.OilFilter.Fram}</p> <p className=" ml-5">K&N: {mazda6.OilFilter.KN}</p></div>
                    ...
                    <div className=" ml-5 p-3 border-2 bg-gray-200  border-black h-12 mt-2 text-center items-center flex justify-center">Back: {mazda6.Lights.BackUp} <p className="ml-5">Trunk: {mazda6.Lights.Trunk}</p><p className="ml-5">Courtesy/License: {mazda6.Lights.CourtesyLicense}</p></div>
